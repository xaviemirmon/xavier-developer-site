...
├── backend│ ├── packages│ └── starters├── docs├── frontend│ ├── deprecated-packages│ ├── packages│ └── starters└── scripts
...
### It's been 3 months since I first wrote about our efforts to scale Git to extremely large projects and teams with an…

devblogs.microsoft.com

](https://devblogs.microsoft.com/bharry/the-largest-git-repo-on-the-planet/?source=post_page-----89bdae57f221--------------------------------)

[

## What is monorepo? (and should you use it?) - Semaphore

### Monorepos can foster rapid development workflows. In this post, we'll examine if they are the right fit for you and…

semaphoreci.com

](https://semaphoreci.com/blog/what-is-monorepo?source=post_page-----89bdae57f221--------------------------------)

[

## Monorepo: please do!

### You should choose a monorepo because the default behavior it encourages in your teams is visibility and shared…

medium.com

](https://medium.com/@adamhjk/monorepo-please-do-3657e08a4b70?source=post_page-----89bdae57f221--------------------------------)

[

## Building large scale react applications in a monorepo

### A monorepo can be described as a repository that contains more than one logical project. These projects can be…

medium.com

](https://medium.com/@luisvieira_gmr/building-large-scale-react-applications-in-a-monorepo-91cd4637c131?source=post_page-----89bdae57f221--------------------------------)
