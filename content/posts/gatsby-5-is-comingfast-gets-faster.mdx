...
![Gatsby 5 promo image — source: [https://www.gatsbyjs.com/gatsby-5/](https://www.gatsbyjs.com/gatsby-5/)](https://cdn-images-1.medium.com/max/4680/1*Rjiq5h_kDa0XE4MMR7iAgQ.png)
...
More info:
[**Using Slices | Gatsby**
*Support for the Gatsby Slice API was added in gatsby@5.0.0. To further the improvements seen by Incremental Builds…*v5.gatsbyjs.com](https://v5.gatsbyjs.com/docs/how-to/performance/using-slices/)
[**The Gatsby Slice API: High Precision Incremental Builds | Gatsby**
*Serving fully-rendered, static HTML files has made a few trips in and out of the web development sphere over the past…*v5.gatsbyjs.com](https://v5.gatsbyjs.com/blog/gatsby-slice-api)
...
*There's been a lot of content around Gatsby 5, and we can't help but be excited. Today I want to deep dive into a beta…*www.gatsbyjs.com](https://www.gatsbyjs.com/blog/partial-hydration-beta-explained)
[**Partial Hydration | Gatsby**
*Partial Hydration enables you to selectively add interactivity to your otherwise completly static app. This results in…*v5.gatsbyjs.com](https://v5.gatsbyjs.com/docs/conceptual/partial-hydration/)
...
*To ensure that websites are found by the intended users, search engines inspect websites for specific bits of metadata…*www.gatsbyjs.com](https://www.gatsbyjs.com/blog/introducing-the-gatsby-head-api/)
[**Gatsby Head API | Gatsby**
*Support for the Gatsby Head API was added in gatsby@4.19.0. Gatsby includes a built-in Head export that allows you to…*www.gatsbyjs.com](https://www.gatsbyjs.com/docs/reference/built-in-components/gatsby-head/)
...
*I am curious to know your thoughts. What are you most excited about with this release? Add it in the comments below.*